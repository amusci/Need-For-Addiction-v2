class Wheels {
    ...
    public void make(Trackers trackers, Plane aplane[], int i, int j, int k, int l, int i1, int j1,
        ...
        ai1[15] = (int) (k - 5F * f1);
        ai2[15] = (int) (l + 12F * f1);
        aplane[i] = new Plane(trackers, ai, ai2, ai1, 16, ai3, false, l1, 0, i2, k, l, 7, 0, false, 0, false, false);
        //1
        mast++;
        ...
        ai2[1] = (int) (l + 5F * size);
        aplane[i] = new Plane(trackers, ai, ai2, ai1, 3, rc, false, j2, 0, i2, k, l, 7, 0, false, 0, false, false);
        //2
        i++;
        ...
        ai1[3] = (int) (k - 12F * f1);
        ai2[3] = (int) (l + 5F * f1);
        aplane[i] = new Plane(trackers, ai, ai2, ai1, 4, ai3, false, l1, -1 * byte0, i2, k, l, 7, 0, false, 0, false, false);
        //8
        i++;
        ai[0] = (int) (j - 4F * f);
        ai1[0] = (int) (k - 5F * f1);
